...
课程的正式名称为《信息安全课程综合实践》，课程代码为 CS1264M，学分为 2.5 学分。
...
!!! warning "有意的同学务必通过提交Lab0的方式提前报名"
    ...
    在选择该门课程时，可以同时选择任一课程代码为 CS1030M 的《课程综合实践Ⅰ》课程，不会出现冲突。

    非信安专业的同学可以选择该门**信息安全课程综合实践** 作为其他《课程综合实践Ⅰ》课程的替代课程，我们会根据lab0的完成情况来进行筛选，筛选后名单会交给教学科处理。
