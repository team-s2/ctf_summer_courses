...
顺带一提，BUUCTF 是一个很不错的公开练习平台！不过最近 BUUCTF 已被归档，原本的题目均迁移至本题所述的新平台 CTF^2 中，然而新平台由于~~vibe coding~~处于测试阶段，目前稳定性不是很好，对 firefox 等浏览器的前段支持也存在诸多 bug，请同学们尽量不要过于贴近 DDL 做本题，以防不可控情况发生。
