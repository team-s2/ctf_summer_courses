...
[CryptoHack](https://cryptohack.org/) 是一个非常适合自学密码学知识的题目平台，你需要注册并完成 [CryptoHack - General challenges](https://cryptohack.org/challenges/general/) 中 **Mathematics** 板块的五道基础数学知识题，在实验报告中给出解题过程。
